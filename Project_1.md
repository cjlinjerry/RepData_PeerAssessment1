...
![](Project_1_files/figure-markdown_strict/unnamed-chunk-3-1.png)
...
Build a time series plot of the 5-minute interval and the average number
of steps taken
...
![](Project_1_files/figure-markdown_strict/unnamed-chunk-7-1.png)

Looks like on average people have highest number of steps during the
morning
...
Let's simply use the mean for each 5-minute interval to replace the
missing values here and create a new dataset
...
![](Project_1_files/figure-markdown_strict/unnamed-chunk-11-1.png)
...
The median of the total number of steps taken per day for the new
dataset is:
...
As we can see, the mean steps maintain the same, while the median steps
increase a little bit

-   Let's further check if there are differences in activity patterns
    between weekdays and weekends

We first create a new factor variable in the dataset with two levels –
...
![](Project_1_files/figure-markdown_strict/unnamed-chunk-15-1.png)

During the weekdays, people tend to have the highest number of steps in
the morning  
